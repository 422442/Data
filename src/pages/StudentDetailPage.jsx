        ...
        <div style={{ maxWidth: '1100px', margin: '0 auto', padding: '1.5rem 1rem 4rem' }}>
            ...
            <div className="password-card" style={{
                ...
                <button
                    ...
                    disabled={fetchingPassword || cooldown > 0}
                    onClick={async () => {
                        if (fetchingPassword || cooldown > 0) return;
                    ...
                    style={{
                        ...
                        opacity: (fetchingPassword || cooldown > 0) ? 0.6 : 1,
                        whiteSpace: 'nowrap', flexShrink: 0,
                        cursor: (fetchingPassword || cooldown > 0) ? 'not-allowed' : 'pointer'
                    }}
                >
                    <RefreshCw size={14} style={{
                        animation: fetchingPassword ? 'spin 1s linear infinite' : 'none',
                    }} />
                    {fetchingPassword ? 'Fetching...' : cooldown > 0 ? `Wait ${cooldown}s` : 'Fetch Latest'}
                </button>
            </div>
